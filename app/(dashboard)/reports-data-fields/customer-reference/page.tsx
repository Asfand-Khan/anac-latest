...
export const metadata: Metadata = {
    title: "Customer Reference | Anac Lubricants",
...
const page = async () => {
    ...
    return (
        <>
            <SubNav title="Customer References" showDatePicker={true} showDataTableFilters={true} />
            <Card className="w-full shadow-none border-0">
                <CardHeader className='border-b py-4'>
                    <CardTitle className='tracking-tight text-lg font-semibold'>Explore your customer references</CardTitle>
                </CardHeader>
                <CardContent>
