...
export const metadata: Metadata = {
    title: "Part Make & Type | Anac Lubricants",
...
const page = async () => {
    ...
    return (
        <>
            <SubNav title="Part Make & Type" showDatePicker={true} showDataTableFilters={true} />
            <Card className="w-full shadow-none border-0">
                <CardHeader className='border-b py-4'>
                    <CardTitle className='tracking-tight text-lg font-semibold'>Explore your part make & type</CardTitle>
                </CardHeader>
                <CardContent>
