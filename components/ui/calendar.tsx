  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary-100 text-neutral-50 hover:bg-primary-100 hover:text-neutral-50 focus:bg-primary-100 focus:text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
        day_today: "bg-zinc-100 text-black dark:bg-neutral-800 dark:text-neutral-50",
        day_outside:
